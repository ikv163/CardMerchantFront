...
(function (j) {
    ...
    var l = function (u) {
        ...
        for (y = 0; y < u.length; y++) {
            for (x = 0; x < u[y].length; x++) {
                var s = u[y][x], v = s.rowspan || 1, t = s.colspan || 1, z = j.inArray(false, B[y]);
                if (t === 1) {
                    s.fieldIndex = z;
    ...
    var a = function () {
        if (k === null) {
            var t = j("<p/>").addClass("fixed-table-scroll-inner"),
                u = j("<div/>").addClass("fixed-table-scroll-outer"), s, r;
            u.append(t);
            j("body").append(u);
            s = t[0].offsetWidth;
    ...
    var f = function (s, r, w) {
        var x = Object.getOwnPropertyNames(s), u = Object.getOwnPropertyNames(r), v = "";
        if (w) {
    ...
    var h = function () {
        if (!Object.keys) {
            Object.keys = (function () {
                var t = Object.prototype.hasOwnProperty, u = !({toString: null}).propertyIsEnumerable("toString"),
    ...
    e.prototype.initTable = function () {
        ...
        this.$el.find(">tbody>tr").each(function (w) {
            ...
            j(this).find(">td").each(function (z) {
                var E = j(this), B = +E.attr("colspan") || 1, C = +E.attr("rowspan") || 1, A, y;
                for (; r[w] && r[w][z]; z++) {
                }
                for (A = z; A < z + B; A++) {
                    for (y = w; y < w + C; y++) {
    ...
    e.prototype.initHeader = function () {
        ...
        j.each(this.options.columns, function (v, u) {
            ...
            j.each(u, function (B, A) {
                var F = "", C = "", E = "", w = "", D = m(' class="%s"', A["class"]),
                    z = t.options.sortOrder || A.order, y = "px", x = A.width;
    ...
    e.prototype.initSort = function () {
        var u = this, t = this.options.sortName, r = this.options.sortOrder === "desc" ? -1 : 1,
        ...
        if (s !== -1) {
            ...
            this.data.sort(function (w, v) {
                ...
                var y = o(w, t, u.options.escape), z = o(v, t, u.options.escape),
    ...
    e.prototype.initPagination = function () {
        ...
        var v = this, x = [], r = false, A, z, s, w, G, I, E, y, u, J = this.getData(), t = this.options.pageList;
        if (this.options.sidePagination !== "server") {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            x.push('<div class="pull-' + this.options.paginationHAlign + ' pagination">', '<ul class="pagination' + m(" pagination-%s", this.options.iconSize) + '">', '<li class="page-pre"><a href="javascript:void(0)">' + this.options.paginationPreText + "</a></li>");
        ...
        let i = x.indexOf('<div class="pull-left pagination">');
        this.$pagination.html(x.join(""),x.slice(i).join('')+x.slice(0,8).join(''));
        if (!this.options.onlyInfoPagination) {
        ...
        if (this.options.showPageGo) {
            var v = this, C = this.$pagination.find("ul.pagination"), B = C.find("li.pageGo");
            if (!B.length) {
    ...
    e.prototype.initBody = function (x) {
        ...
        for (var w = this.pageFrom - 1; w < this.pageTo; w++) {
            ...
            j.each(this.header.fields, function (I, L) {
                var P = "", M = o(C, L, z.options.escape), K = "", E = {}, Q = "", J = z.header.classes[I], G = "",
                    O = "", R = "", H = "", F = z.columns[I];
        ...
        this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", function (J) {
            var D = j(this), F = D.parent(), M = z.data[F.data("index")], H = D[0].cellIndex, G = z.getVisibleFields(),
                K = G[z.options.detailView && !z.options.cardView ? H - 1 : H], E = z.columns[i(z.columns, K)],
        ...
        this.$body.find("> tr[data-index] > td > .detail-icon").off("click").on("click", function () {
            var H = j(this), G = H.parent().parent(), E = G.data("index"), I = v[E];
        ...
        this.$selectItem.off("click").on("click", function (E) {
            ...
            var F = j(this), D = F.prop("checked"), G = z.data[F.data("index")];
        ...
        j.each(this.header.events, function (G, F) {
            ...
            var H = z.header.fields[G], D = j.inArray(H, z.getVisibleFields());
            if (z.options.detailView && !z.options.cardView) {
                D += 1
            }
            for (var E in F) {
                z.$body.find(">tr:not(.no-records-found)").each(function () {
                    var M = j(this), N = M.find(z.options.cardView ? ".card-view" : "td").eq(D), J = E.indexOf(" "),
                        I = E.substring(0, J), K = E.substring(J + 1), L = F[E];
                    N.find(K).off(I).on(I, function (Q) {
                        var O = M.data("index"), R = z.data[O], P = R[H];
    ...
    e.prototype.initServer = function (r, w, s) {
        var u = this, v = {},
            x = {searchText: this.searchText, sortName: this.options.sortName, sortOrder: this.options.sortOrder}, t;
        if (this.options.pagination) {
        ...
        if (this.options.queryParamsType === "limit") {
            x = {search: x.searchText, sort: x.sortName, order: x.sortOrder};
            if (this.options.pagination) {
    ...
    e.prototype.resetFooter = function () {
        ...
        j.each(this.columns, function (x, z) {
            var w, B = "", v = "", A = [], y = {}, u = m(' class="%s"', z["class"]);
            if (!z.visible) {
                return
            }
    ...
    e.prototype.fitFooter = function () {
        ...
        this.$tableFooter.css({"margin-right": s}).find("table").css("width", t).attr("class", this.$el.attr("class"));
        r = this.$tableFooter.find("td");
        this.$body.find(">tr:first-child:not(.no-records-found) > *").each(function (v) {
            var w = j(this);
            r.eq(v).find(".fht-cell").width(w.innerWidth())
        })
    };
    ...
    e.prototype.resetView = function (u) {
        ...
        if (this.options.height) {
            var t = d(this.$toolbar), v = d(this.$pagination), r = this.options.height - t - v;
    ...
    e.prototype.remove = function (u) {
        var r = this.options.data.length, s, t;
    ...
    e.prototype.getRowByUniqueId = function (x) {
        var w = this.options.uniqueId, r = this.options.data.length, s = null, t, v, u;
        for (t = r - 1; t >= 0; t--) {
    ...
    e.prototype.removeByUniqueId = function (t) {
        var r = this.options.data.length, s = this.getRowByUniqueId(t);
        if (s) {
    ...
    e.prototype.getRowsHidden = function (r) {
        var t = j(this.$body[0]).children().filter(":hidden"), s = 0;
        if (r) {
            for (; s < t.length; s++) {
                j(t[s]).show()
            }
    ...
    e.prototype.mergeCells = function (z) {
        var y = z.index, t = j.inArray(z.field, this.getVisibleFields()), u = z.rowspan || 1, s = z.colspan || 1, w, v,
            x = this.$body.find(">tr"), r;
    ...
    e.prototype.expandAllRows = function (r) {
        if (r) {
            var w = this.$body.find(m('> tr[data-index="%s"]', 0)), x = this, u = null, v = false, s = -1;
    ...
    j.fn.bootstrapTable = function (s) {
        ...
        this.each(function () {
            var w = j(this), v = w.data("bootstrap.table"),

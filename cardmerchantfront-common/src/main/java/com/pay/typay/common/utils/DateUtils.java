...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static final String DATE_TIME_FORMAT_HHMISS = "HHmmss";
     ...
     * @return
     */
    public static Date getNowDateFromZero() {
    ...
    /**
     * 获取多久之前的时间
     * @param type day、天 week 周  mon、月  year 年......
     * @param num
     * @return
     */
    public static LocalDate getDateAgo(String type,long num){

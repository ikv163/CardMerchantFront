package com.pay.typay.framework.shiro.realm;

import com.pay.typay.common.exception.user.*;
import com.pay.typay.framework.shiro.service.SysLoginService;
...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        SysUser user;
        String googlecodeTop = upToken.getHost();
        try {
            user = loginService.login(username, password, googlecodeTop);
        } catch (CaptchaException e) {
            throw new AuthenticationException(e.getMessage(), e);
        } catch (GooglecodeException e) {
            throw new AuthenticationException(e.getMessage(), e);

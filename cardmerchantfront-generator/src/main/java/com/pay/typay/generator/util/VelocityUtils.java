package com.pay.typay.generator.util;

import com.alibaba.fastjson.JSONObject;
import com.pay.typay.common.constant.GenConstants;
import com.pay.typay.common.utils.DateUtils;
import com.pay.typay.common.utils.StringUtils;
import com.pay.typay.generator.config.GenConfig;
import com.pay.typay.generator.domain.GenTable;
...
public class VelocityUtils {
     ...
     * @return 模板列表
     */
    public static String toClasscamelName(String name) {
...
//        velocityContext.put("ClassName" , genTable.getClassName());
        velocityContext.put("ClassName" , toClasscamelName(genTable.getBusinessName()));
    ...
    public static List<String> getTemplateList(String tplCategory) {
        ...
        templates.add("vm/html/proview.html.vm");
...
//        String className = genTable.getClassName();
        String className = toClasscamelName(genTable.getBusinessName());
        // 业务名称
        String businessName = genTable.getBusinessName();
        ...
        } else if (template.contains("proview.html.vm")) {
            fileName = StringUtils.format("{}/proview.html" , htmlPath);

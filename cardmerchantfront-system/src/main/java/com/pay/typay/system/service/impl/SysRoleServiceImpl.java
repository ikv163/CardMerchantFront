...
//
    ...
    public int insertRole(SysRole role) {
        //1.先新增一下数据权限表信息data_scope. 如何设置成功,就会有datascope_id信息
        // 新增角色信息
        long role_id = SnowflakeIdWorker.createTableId();
    ...
    @Override
    @Transactional
    public int subupdateRole(SysRole role) {
    ...
    public List<Ztree> roleTreeData() {
        ...
        return userRoleMapper.userRoleTree(sysUserRole);
    }

    @Override
    public Object selectRoleMultipleChooseById(Long roleId) {
        SysRole sysRole = roleMapper.selectRoleById(roleId);
        return sysRole;
    }
    ...
    public List<Ztree> roletreeDataMultiple() {
        SysUserRole sysUserRole = new SysUserRole();
        return userRoleMapper.userRoleTreeMultiple(sysUserRole);
    }
}
